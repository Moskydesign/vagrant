...
# Mailcatcher
apt-get install -y libsqlite3-dev ruby-dev rubygems build-essential g++ sqlite3
...
# Mailcatcher: add Apache vhost
cat ${CONFIG_PATH}/apache/mailcatcher.vhost.conf > /etc/apache2/sites-available/mailcatcher.${APP_DOMAIN}.conf
